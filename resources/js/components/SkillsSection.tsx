...
const skillsData = [
    {
        ...
        skills: [
            ...
            { name: 'Node.js', level: 'Intermedio', years: '< 1 año' },
        ],
    },
    {
        category: 'Frontend',
        ...
        skills: [
            ...
            { name: 'React', level: 'Básico', years: '< 1 año' },
            { name: 'Inertia.js', level: 'Básico', years: '< 1 año' },
    ...
    },
    {
        ...
        skills: [
            { name: 'MySQL', level: 'Intermedio', years: '3+ años' },
            { name: 'PostgreSQL', level: 'Intermedio', years: '1+ año' },
    ...
    },
    {
        ...
        skills: [
            ...
            { name: 'Docker', level: 'Intermedio', years: '1+ año' },
            { name: 'Flutter', level: 'Básico', years: '1+ año' },
            { name: 'Composer', level: 'Intermedio', years: '2+ años' },
